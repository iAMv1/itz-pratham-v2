...
export function Footer() {
  return (
    <footer className="flex flex-wrap items-center justify-between gap-4 border-t-[3px] border-mint bg-ink-2 px-[clamp(20px,4vw,48px)] py-5 text-paper max-sm:flex-col max-sm:items-start max-sm:gap-2">
